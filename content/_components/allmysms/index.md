...
receivers using the [AllMySMS API](https://doc.allmysms.com/api/en/).
...
*   **Mobile numbers** - List of receivers mobile numbers separated with comma. E.g. `"3xxxxxxxx,3xxxxxxxxx"`. Recommended to limit number of receivers to 2000. 
> **Please Note:** Specific number validation is not performed by the platform.
