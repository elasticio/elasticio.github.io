...
1\. Get Contracts via the following request:
...
2\. Update membership in the contract via the following request:
...
3\. Remove a user from a contract via the following request:
