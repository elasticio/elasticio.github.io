...
*   If you are member of more than 20 contracts, you will not see them all on the left hand-side. Instead, a link with **load more** will appear which you can use to load more contracts.
