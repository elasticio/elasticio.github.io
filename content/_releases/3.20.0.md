...
## Other
There are new endpoints you can use to see quota statistics for all Workspaces in your Contract. Additionally, there are endpoints for per-task and per-Workspace resource usage control, and Workspace or Contract usage history display. See details [here](#other-stuff).
...
Per-task resource usage, for Workspace members only:
