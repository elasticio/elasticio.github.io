...
The attribute allows you to enable and disable various automatic Platform emails. Related new API docs can be found [here]({{site.data.tenant.apiDocsUri}}/v2#/tenants/post_tenants) and [here]({{site.data.tenant.apiBaseUri}}/docs/v2/#list-of-emails-sent-by-the-platform).
