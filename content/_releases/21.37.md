...
*   Addressed the restriction when Maester environment variables  `ELASTICIO_OBJECT_STORAGE_TOKEN` and `ELASTICIO_OBJECT_STORAGE_URI` were not available during the `verifyCredentials` process.
