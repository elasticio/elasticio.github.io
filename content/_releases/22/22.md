...
*   The attachment and object (a.k.a. `lightwight objects`) retention period is reduced to 3 days (72 hours)
...
Now we obfuscate the REST-API-V2 component header values in the component
Configuration view in case when `basic` or `api-key` authentication is used.
