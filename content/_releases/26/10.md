...
### [Custom Google PubSub component](/components/custom-google-pubsub/) `1.0.0`
*   **Forked from [Google PubSub component](https://github.com/elasticio/google-pubsub)**
*   **Minimal Permissions** works with resource-level permissions (`pubsub.viewer`, `pubsub.subscriber`, `pubsub.publisher`) instead of project-level `pubsub.editor`
*   **Manual Subscription Management** Subscriptions must be created manually before use (no automatic creation/deletion)
*   **IMPROVED** Improved validation and error messages for missing subscriptions and permissions

### [Sailor Nodejs](/components/) `2.7.8`
