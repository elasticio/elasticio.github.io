...
description: Details of the product update v26.19 from the 6th of May 2026.
layout: rel
version: "26.19"
...
## Fixed Bugs
*   **FIXED** a bug that caused Webhook component pods to enter an Error state and restart when a sample request with `?raw=true was sent with "Content-Type: multipart/form-data"`. The system now handles these requests without crashing.
...
*   **Breaking Changes:** Moving to the dynamic metadata might break existing flow mapping. Please check your flows after upgrading.
