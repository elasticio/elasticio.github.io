...
*   **FIXED** a bug where the Back button worked only once and did not allow further navigation through browsing history on the Flow page  
...
*   **FIXED** variable fields not being required or validated on the recipe activation page (frontend validation added)  
*   **FIXED** a UI crash when switching between REST API configurations  
...
*   **UPDATED** `Sailor` version to `5.0.1` to address the issue when the component failed to execute when there was an array in any of the preceding steps passthrough data
