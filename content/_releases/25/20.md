...
A three dots icon has been added next to OAuth 2.0 auth-client name in the dropdown menu when creating a secret. 
It is now possible to manage authentication clients via the UI. You can edit or remove OAuth2 clients or remove other types of clients.
