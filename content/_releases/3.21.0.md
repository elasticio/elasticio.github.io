...
Another important thing - Docker Registry service doesn't run under the root user any more and requires migration. See instructions [here](#docker-migration).
