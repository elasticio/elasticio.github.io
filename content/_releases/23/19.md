...
Starting from the next release `22.23` the `Recipe` feature will be available for the tenant-level of subscription. For Enterprise subscriptions the `Recipe` feature will be available at additional cost. please contact sales@elastic.io for details.
