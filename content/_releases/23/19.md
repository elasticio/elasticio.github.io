...
* We added a new `node_config` option `consume_raw_data`. This parameter configures the parsing behaviour in the webhook step. In case it is true, the webhook step receives an input message in the raw structure.
