...
* Transferred the Workspace Quota Usage graph from the Quota page - *clicking the workspace name in the `Workspace Memory Usage` list on the `Current Month Quota` page will redirect the user to the corresponding workspace Dashboard.*
