...
*   Addressed the case with the null result of the component select-model by showing a clear error message and asking the user to manually reload the select model.
