...
![](/assets/img/managing-workspaces/Screenshot_1.png)

2\.  Enter new workspace name and click **Create**:

![](/assets/img/managing-workspaces/Screenshot_2.png)

3\.  Your new workspace is ready:
![](/assets/img/managing-workspaces/Screenshot_3.png)
...
![](/assets/img/managing-workspaces/Screenshot_26.png)

5\. Choose your contract:

![](/assets/img/managing-workspaces/Screenshot_27.png)

6\. In **Workspaces tab**, click **Create New Workspace**:
![](/assets/img/managing-workspaces/Screenshot_28.png)
...
![](/assets/img/managing-workspaces/Screenshot_10.png)

To delete workspace, click **Delete workspace**:

![](/assets/img/managing-workspaces/Screenshot_5.png)
...
![](/assets/img/managing-workspaces/Screenshot_11.png)

Alternatively, you can click **Add New Flow** in **Flows**:

![](/assets/img/managing-workspaces/Screenshot_17.png)

2\.  Your new flow is ready. Be sure to name it and write a description, which is optional:

![](/assets/img/managing-workspaces/Screenshot_12.png)
...
![](/assets/img/managing-workspaces/Screenshot_14.png)

You will see your flow control page, where you can rename, start, stop, edit,
and delete the flow:

![](/assets/img/managing-workspaces/Screenshot_15.png)

Click **Settings** to access the settings tab where you can toggle flow type:

![](/assets/img/managing-workspaces/Screenshot_16.png)
...
![](/assets/img/managing-workspaces/Screenshot_13.png)
...
![](/assets/img/managing-workspaces/Screenshot_22.png)

2\.  Click **Add New Credential** and fill in the appearing fields. When done,
    click **Verify**:

![](/assets/img/managing-workspaces/Screenshot_19.png)

![](/assets/img/managing-workspaces/Screenshot_20.png)
...
![](/assets/img/managing-workspaces/Screenshot_29.png)

5\. Click **Add the initial step** or **edit flow** button, depending on the existence of flow steps:

![](/assets/img/managing-workspaces/Screenshot_30.png)

![](/assets/img/managing-workspaces/Screenshot_31.png)

6\. Search for your component in the list and click it:

![](/assets/img/managing-workspaces/Screenshot_32.png)  

7\. Click **connect new credentials**:

![](/assets/img/managing-workspaces/Screenshot_34.png)
